...
class OproEngine:
    ...
    """
    def __init__(self, base_prompt, task_examples, num_iterations=3, candidates_per_iter=4, api_key=None):
    ...
    def generate_candidates(self, prompt):
        ...
        for _ in range(self.candidates_per_iter):
            instruction = f"Rewrite or improve this prompt for better task performance: {prompt}"
